...
import { isAnswerCorrect } from './features/quiz/answerChecking';
...
const App: React.FC = () => {
  ...
  const handleAnswerChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const isAnsCorrect = isAnswerCorrect(currentQuestion, answer);
  ...
  return (
    ...
    >
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <button
                      ...
                      onClick={() => setAppBackgroundColor('bg-gray-100 dark:bg-gray-900')}
                    ...
                    <button
                      ...
                      onClick={() => setAppBackgroundColor('bg-blue-50 dark:bg-slate-800')}
                    ...
                    <button
                      ...
                      onClick={() => setAppBackgroundColor('bg-green-50 dark:bg-gray-800')}
                    ...
                    <button
                      ...
                      onClick={() => setAppBackgroundColor('bg-pink-50 dark:bg-gray-800')}
                ...
                <div>
                  <label className="flex items-center gap-3 mb-3 font-semibold text-gray-700 dark:text-gray-300">
                    <input
                      ...
                      onChange={(e) => setIsInterestEnabled(e.target.checked)}
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      value={urgencyTime}
                      onChange={(e) =>
                        setUrgencyTime(Math.max(1, parseInt(e.target.value, 10)) || 1)
                      }
          ...
          <div className="absolute inset-0 bg-gray-900/80 backdrop-blur-sm flex flex-col items-center justify-center z-20 rounded-2xl p-4">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col items-center">
              ...
              <div className="w-full h-auto max-h-[60vh] flex items-center justify-center mb-6">
                {interestFile?.type.startsWith('image/') && (
                  <img
                    src={interestFileUrl}
                    alt="Reward"
                ...
                {interestFile?.type.startsWith('video/') && (
                  <video
                    src={interestFileUrl}
                    controls
                    autoPlay
                ...
                {interestFile?.type.startsWith('audio/') && (
                  <audio src={interestFileUrl} controls autoPlay className="w-full" />
                )}
              </div>
              <button
                ...
                <div className="mt-4 overflow-x-auto relative shadow-md sm:rounded-lg">
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr>
                        {currentQuestion.data.headers.map((header) => (
              ...
              <div className="flex-grow relative border-2 border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden">
                ...
                <div className="absolute bottom-4 right-4 z-10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-4 rounded-lg shadow-lg w-full max-w-xs">
                  ...
                  <input
                    ...
                    className={`w-full p-3 border-2 rounded-lg bg-gray-50 dark:bg-gray-700 font-semibold focus:outline-none focus:ring-2 transition-all duration-300 ${getAnswerBorderColor()}`}
                    autoComplete="off"
                  />
      ...
      {isUrgencyEnabled && !isFinished && (
        <div
          className={`mt-6 text-9xl font-mono font-bold tracking-wider transition-colors duration-500 ${getTimerColor()}`}
        >
