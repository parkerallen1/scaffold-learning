...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    id: 9,
    question:
      'Two years ago, your friend was 1.25 meters tall. Today, your friend is 1.48 meters tall. How many meters did your friend grow?',
    answer: '0.23',
  },
  {
    id: 10,
  ...
  },
  {
    id: 11,
    question:
      'MP Reasoning: Can you use the Commutative Property to find the difference of two decimals? Explain.',
    answer: 'No, subtraction is not commutative.',
  },
  {
    id: 12,
    question:
      'DIG DEEPER: Use each digit from 1 through 8 once to complete the problem. [ ][ ].[ ][ ] + [ ][ ].[ ][ ] = 101.52',
    answer: '25.14 + 76.38',
  },
];
